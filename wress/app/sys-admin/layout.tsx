...
import AppSidebar from "@/components/layout/sidebar/sysadmin-sidebar"
...
function SysAdminDashboardContent({
  ...
  useEffect(() => {
    ...
    if (!isLoading && userId && user && user.user_type !== "System Admin") {
      router.push("/unauthorized")
    }
  }, [isLoading, userId, user, router])
  ...
  if (user && user.user_type !== "System Admin") {
    return null
  }
...
export default function DashboardLayout({
  ...
  return (
    <AuthProvider>
      <SysAdminDashboardContent>{children}</SysAdminDashboardContent>
    </AuthProvider>
  )
}