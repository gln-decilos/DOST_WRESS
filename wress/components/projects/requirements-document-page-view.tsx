...
export default function RequirementsDocumentPageView({
  projectId,
  documentId,
}: {
  projectId: number
  ...
  const createNewVersion = async (changeType: "minor" | "major") => {
    ...
    try {
      ...
      router.push(`/project/${projectId}/requirements/${data.document.id}`)
    } catch (error) {
    ...
    <section className="w-full rounded-2xl bg-card p-6 shadow-sm ring-1 ring-border md:p-8">
      ...
      <div className="mb-6 rounded-2xl bg-background p-6 ring-1 ring-border">
        ...
        <div className="mt-6 flex flex-wrap gap-2">
          {documentSummary.status === "Draft" && canEditRequirements && (
            <button
              type="button"
          ...
          {documentSummary.status === "Approved" && canEditRequirements && (
            <button
              type="button"
          ...
          {documentSummary.status === "Frozen" && canEditRequirements && (
            <button
              type="button"
      ...
      <div className="overflow-hidden rounded-2xl bg-background ring-1 ring-border">
        <div className="flex flex-col gap-3 border-b border-border px-6 py-4 md:flex-row md:items-center md:justify-between">
          ...
          {canCreateRequirements && canModify && template && (
            <button
              type="button"
                  ...
                  <tr key={requirement.id} className="border-t border-border hover:bg-muted/30">
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-2">
                        ...
                        {canDeleteRequirements && canModify && (
                          <button
                            type="button"
